  ...
  <div class="modal-body">
	<form id="applicationform">
      <div class="form-group row email-group">
        ...
        <div class="form-group row jobid-group">
          <label for="jobId" class="col-sm-2 col-form-label">Job ID:</label> 
            <div class="col-sm-10">
              <input type="text" class="form-control" id="jobId" placeholder="Job Id" name="jobId"> <!-- span id="id_error" class="errors"></span> -->
            </div>  
        </div>
         <div class="form-group row category-group">
          <label for="category" class="col-sm-2 col-form-label">Type of Leave:</label>
            <div class="col-sm-10">
              <select name="category" class="form-control">
                <option value=""></option>
                <option value="Annual">Anual Leave</option>
        ...
        <div class="form-group row daysTaken-group">
          <label for="daysApplied" class="col-sm-2 col-form-label">Days Applied:</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="daysTaken"  name="daysTaken" placeholder="no of days to apply"> 
            </div>
        </div>
        <div class="form-group row startDate-group">
            <label for="startDate" class="col-sm-2 col-form-label">Start Date:</label>
            <div class="col-sm-10">
              <input type="datetime-local" class="form-control" id="startDate" name="startDate" placeholder="start date">
            </div>
        </div>
        <div class="form-group row endDate-group">
        ...
        <div class="form-group row phone-group">
           <label for="address" class="col-sm-2 col-form-label">Phone Number</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="phone" name="phone" placeholder="current Phone number">   
            </div>
        </div>
          <input type="hidden" name="status" id="hidden" value="Pending">
          <input type="submit" class="btn btn-primary" id="submit" value="Apply">
    </form>
      </div>
       <div id="result" style="display: none;" class="alert alert-success" role="alert">  Application successful</div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" id="id">Close</button>
      </div>
    </div>
  </div>
</div>
